<template lang="pug">
   .container
      ...
      section.lead
         .elevator
            h1 Hey I'm aHnaine 👋
            p  I am Front-End Web Developer from morocco, i love development 
               | and i'm creating open source projects using:
               br
               | JavaScript &amp; Vue.js
...
export default {
   ...
   created() {
      axios
         .get(`https://api.github.com/users/aHnaine3dev/repos`)
         .then(response => {
